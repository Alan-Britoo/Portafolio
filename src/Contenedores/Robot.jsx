      ...
      {expanded && (
        <div className="mt-2 rounded-lg shadow-md p-1 flex flex-col gap-3 transition-all duration-1000">
          ...
          <a
            ...
            className="flex items-center gap-2"
          >
            <img src={Wp2} alt="WhatsApp" className="w-12 h-12" />
          </a>
          <a
            href="mailto:rotcarrillo_8@hotmail.com"
            className="flex items-center gap-2 mb-2"
          >
            <img src={Gm} alt="Correo" className="w-12 h-12" />
          </a>
        </div>
      )}
      <div
        className="w-14 h-14 bg-gradient-to-r from-pink-500 to-blue-600 rounded-full flex items-center justify-center cursor-pointer shadow-lg animate-pulse transform hover:scale-110 transition duration-1000"
