...
export default function InfoNavbar({ toggleAbout }) {
  return (
    <div className="flex justify-between  items-center  bg-[#191919] text-[#A7A7A7] w-full  pt-[2%] max-sm:bg-[#191919]   sm:bg-[#191919] md:bg-[#191919] lg:bg-[#191919] ">
      <img
        className="hover:scale-110 transition duration-200 ease-in-out pl-[10%] w-[228px] h-[58px] max-md:w-[150px] max-md:h-12"
        src={icono}
        alt=""
      />
      <div className="flex w-[98%] gap-[5%] text-[18px] items-center justify-center  ">
        <a
          href="#home"
          className="bg-gradient-to-r  hover:from-pink-600 hover:to-blue-500 hover:scale-110 transition duration-500 hover:pb-1 ease-in-out px-3 py-[1px] rounded-md max-md:hidden"
        >
          <NavBar nom={"Home"} />
        </a>
        <a
        ...
        <a
          href=""
          className="bg-gradient-to-r  hover:from-pink-600 hover:to-blue-500 hover:scale-110 transition duration-200 hover:pb-1 ease-in-out px-3 py-[1px] rounded-md max-sm:hidden"
        >
          <NavBar nom={"Contact"} />
        </a>
      </div>
